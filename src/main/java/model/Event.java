...
@NamedQueries({ @NamedQuery(name = "Event.getEventById", query = "SELECT e FROM Event e WHERE e.idevent = :idevent"),
	@NamedQuery(name = "Event.getEventByName", query = "SELECT e FROM Event e WHERE e.artistName = :artistName"),
